...
export const putDb = async (content) => {console.error('jateDb not implemented');
...
// TODO: Add logic for a method that gets all the content from the database //unit 23
export const getDb = async () => {
  console.error('get database not implemented ');
